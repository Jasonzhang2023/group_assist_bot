...
# 操作说明
```bash
v1.4--带有群组管理面板，可以封禁用户（移除群聊），单用户禁言，群组禁言
v1.5--修复图片、视频等多媒体下载（包含nginx配置文件nginx.conf、groupass.cfacca.com.conf），筛选
v1.6--轻度禁言，只准发送文本文字，有自动禁言功能
v1.7--查看群员信息
v1.8--入群验证功能
v1.9--垃圾信息检测
v2.0--整合需要用户修改的配置文件
v2.1--修正群组成员列表
v2.2--群组成员列表 不超过主窗口（目前最新版本）
